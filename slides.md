...
`首先看一组硬数据。现在的 3A 游戏（大投入、大制作）正面临一场‘生存危机’。开发成本从 PS3 时代的 5000 万美金，飙升到了现在的 2 亿美金起步。这意味着什么？意味着游戏公司越来越不敢创新。为了回本，他们只能做换皮续作，因为一旦失败就是破产。`
---
...
`看这两个极端的成功案例。《GTA 5》靠砸 2.6 亿美金换来了 3 天 10 亿的营收，这是资本的胜利。但更值得关注的是《黑神话：悟空》，它的预算只有 4000 多万美金，却靠极致的人均产出比引爆了全球。这说明：高预算不等于成功，内容密度和开发效率才是死穴`
---
...
`为什么开发游戏这么慢？因为 70% 的时间都花在了‘搬砖’上——改模型、修草坪、写那些没人看的路人台词。真正的核心创意只占 15%。这种‘体力劳动’占比过高的工业化标准，正在产生边际效应递减。我们需要一种工具，把人从砖堆里拉出来。`
---
...
`育碧给出了第一个答案：Ghostwriter（AI 编剧）。它专门处理那些量大、乏味的‘环境对话’。比如你在《刺客信条》里路过一个菜市场，周围 NPC 的闲聊不再需要编剧一行行去写，而是由 AI 生成初稿，人类只需审核。效率直接提升了 10 倍，让编剧能腾出手来写更感人的主线`
...
`如果说 Ghostwriter 解决了‘写字’，那 NVIDIA 的 ACE 引擎就解决了‘互动’。它把 NPC 的大脑换成了 LLM（大语言模型）。以前你问 NPC 问题，他只会复读机；现在，他能根据环境实时推理并回答，而且延迟控制在 300 毫秒内，几乎和真人对话一样自然。`
...
`画面党最关注的来了：DLSS 5。以前显卡是‘老老实实画图’，现在是**‘靠 AI 脑补图’**。通过神经渲染，渲染效率提升了 500%。这意味着未来的学生笔记本，也能跑出以往万元级工作站才有的电影级画面。`
---
...
`痛点： 独立开发者没钱给 OpenAI 付高昂的接口费。`
`方案： 我们把大模型（Llama 3）做‘减肥’处理，让它在用户本地显卡上就能跑。`
`口号： 让每一个没钱、没人的独立开发者，都能拥有构建 3A 级智能世界的能力。`
---
layout: center
class: text-center
---
...
`总结一下：AI 带来的不是失业，而是生产力的平权。它通过‘降本’和‘增效’，正在重塑这个行业。正如那句话所说：AI 不会取代开发者，但懂得利用 AI 的开发者将重塑游戏行业。谢谢大家，欢迎提问！`
---